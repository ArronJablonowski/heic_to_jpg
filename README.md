...
It is designed for quick photo cleanup job: point it at a folder, optionally recurse through subfolders, choose an output directory, decide how existing files should be handled, and delete originals only after successful conversion.
